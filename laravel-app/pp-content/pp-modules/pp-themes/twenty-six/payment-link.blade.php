          ...
          <div class="card-body text-center py-3 p-sm-4">
            ...
            @else
                ...
                <svg class="img mb-n2" xmlns="http://www.w3.org/2000/svg" height="200" fill="none" viewBox="0 0 800 600">
                    <style>
                        :where(.theme-dark, [data-bs-theme="dark"]) .tblr-illustrations-boy-girl-a { fill: black; opacity: 0.07; }
                        :where(.theme-dark, [data-bs-theme="dark"]) .tblr-illustrations-boy-girl-b { fill: #1a2030; }
                        :where(.theme-dark, [data-bs-theme="dark"]) .tblr-illustrations-boy-girl-c { fill: #454c5e; }
                    </style>
                    ...
                    <path d="M271.554 222.127C271.554 233.832 285.644 243.3 303.069 243.3C320.494 243.3 334.519 233.832 334.519 222.127C334.52 221.496 334.457 220.867 334.331 220.249C324.476 217.949 314.441 216.504 304.337 215.927C293.815 215.329 283.263 215.495 272.765 216.425C271.953 218.216 271.539 220.161 271.554 222.127Z" fill="#FFCB9D"></path>
                    ...
                    <path d="M543.657 336.39L536.311 514.22H521.873L501.893 376.83L488.178 514.22H477.479L458.213 336.39H543.657Z" fill="#0455A4" style="fill: #0455a4;"></path>
                    ...
                    <path d="M494.801 195.468L473.956 180.495L469.194 185.539L483.359 206.694L494.801 195.468ZM495.778 195.318L527.368 175.629L534.582 182.261L513.118 210.075L495.778 195.318Z" fill="#0455A4"></path>
                    <path d="M494.801 195.468L473.956 180.495L469.194 185.539L483.359 206.694L494.801 195.468Z" fill="black" opacity="0.22"></path>
                </svg>
                <h1 class="mt-5">{{ $paymentLink['product']['title'] }}</h1>
          ...
          @if($paymentLink['status'] === "active")
            <div class="card-body">
                <form action="" method="POST" id="form" enctype="multipart/form-data">
                    @php pp_renderFormFields('payment-link', $pageData); @endphp
            ...
            $('#form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        document.querySelector("#payButton").innerHTML = '{{ $lang['pay_now'] }}';
                        if (data.status == "true") {

        ...
        <div class="card card-md">
            <div class="card-body text-center py-3 p-sm-4">
                ...
                <svg class="img mb-n2" xmlns="http://www.w3.org/2000/svg" height="200" fill="none" viewBox="0 0 800 600">
                    ...
                    <path d="M494.801 195.468L473.956 180.495L469.194 185.539L483.359 206.694L494.801 195.468ZM495.778 195.318L527.368 175.629L534.582 182.261L513.118 210.075L495.778 195.318Z" fill="#0455A4" style="fill: #0455a4;"></path>
            ...
            <div class="card-body">
                <form action="" method="POST" id="form" enctype="multipart/form-data">
                    @php pp_renderFormFields('payment-link-default', $pageData); @endphp

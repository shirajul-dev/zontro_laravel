<?php
    ...
    $pp_functions_path = base_path('pp-content/pp-include/pp-functions.php');
                ...
                switch ($route) {
                    ...
                    case 'ipn':
                        ...
                        if($response_gateway['status'] == false){
                            ...
                            if($response_brand['status'] == true){
                                ...
                                if(file_exists(base_path() . '/pp-content/pp-modules/pp-gateways/'.$response_gateway['response'][0]['slug'].'/class.php')){
                                    require_once base_path() . '/pp-content/pp-modules/pp-gateways/'.$response_gateway['response'][0]['slug'].'/class.php';
                    ...
                    case $path_payment:
                        ...
                        if($response_transaction['status'] == true){
                            ...
                            $response_brand = json_decode(getData($db_prefix.'brands','WHERE brand_id = :brand_id', '* FROM', $params),true);
                            if($response_brand['status'] == true){
                                if(file_exists(base_path() . '/pp-content/pp-modules/pp-themes/'.$response_brand['response'][0]['theme'].'/class.php')){
                                    require_once base_path() . '/pp-content/pp-modules/pp-themes/'.$response_brand['response'][0]['theme'].'/class.php';

        ...
        <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
            <div class="flex flex-col justify-center gap-2">
                ...
                <div class="flex items-center gap-2 text-sm font-normal text-secondary-foreground">
                    Update pricing and access constraints for this tier
                </div>
            </div>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content grid gap-5 pt-4">
                            <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                                ...
                                <div class="grow">
                                    <input class="kt-input w-full" name="name" value="{{ old('name', $plan->name) }}" type="text" required>
                                </div>
                            </div>
                            <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="kt-form-label max-w-48 w-full">Plan Slug <span class="text-danger">*</span></label>
                                <div class="grow">
                                    <input class="kt-input w-full" name="slug" value="{{ old('slug', $plan->slug) }}" type="text" required>
                                </div>
                            </div>
                            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                                <label class="kt-form-label max-w-48 w-full">Description</label>
                                <div class="grow">
                                    <textarea class="kt-input w-full min-h-[100px]" name="description" placeholder="Briefly describe what this plan offers...">{{ old('description', $plan->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="grow">
                                            <div class="flex justify-between items-center mb-1">
                                                ...
                                                <label class="kt-switch kt-switch-sm">
                                                    <input type="checkbox" name="features[{{ $module['key'] }}]" id="feat_{{ $module['key'] }}" {{ old('features.'.$module['key'], $plan->hasFeature($module['key'])) ? 'checked' : '' }}>
                                                </label>
                                            </div>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content grid gap-5 pt-4">
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="relative">
                                    <input class="kt-input w-full ps-12" name="price" value="{{ old('price', $plan->price) }}" type="number" step="0.01" required>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input class="kt-input w-full uppercase" name="currency" value="{{ old('currency', $plan->currency) }}" type="text" maxlength="3">
                            </div>

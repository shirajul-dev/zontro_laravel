                            ...
                            <div class="row g-3">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Full Name" value="{{ $global_user_response['response'][0]['full_name'] }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="{{ $global_user_response['response'][0]['username'] }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="email" class="form-control" id="email-address" name="email-address" placeholder="Email Address" value="{{ $global_user_response['response'][0]['email'] }}" required>
                                        </div>
                                    </div>
                                </div>
...
?>
        ...
        <script data-cfasync="false">
            $('.form-my-account-two-factor-authentication').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ url(trim((string) config('piprapay.paths.admin', 'admin'), '/') . '/dashboard') }}',
                    data: formData,
                    dataType: 'json',
                    success: function (response) {
                        ...
                        if (response.status === 'true') {
                            ...
                            location.href = '{{ url(trim((string) config('piprapay.paths.admin', 'admin'), '/') . '/my-account') }}';
                        } else {
                            createToast({
                                title: response.title,
                                description: response.message,
                ...
                <div class="modal-content">
                    <form action="" class="form-my-account-two-factor-authentication">
                        ...
                        <div class="modal-body">
                            ...
                            <center>
                                <img src="{{ $qrCodeUrl }}" style=" max-width: 180px; " class="img-fluid border p-3 rounded m-2 two-factor-authentication-qr-code" alt="">
                            </center>

                            <p class="mt-3">Or enter this code manually: <strong>{{ $global_user_response['response'][0]['2fa_secret'] }}</strong></p>

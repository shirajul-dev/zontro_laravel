                            ...
                            <div class="col-md-4 mb-2">
                                <label class="form-check">
                                    <input type="checkbox"
                                        ...
                                        value="view_balance"
                                        checked>
                                    <span class="form-check-label" style="font-size: 0.875rem;font-weight: 500;">View Balance</span>
                                </label>
                            </div>
                            <div class="col-md-4 mb-2">
                                <label class="form-check">
                                    <input type="checkbox"
                                        ...
                                        checked>
                                    <span class="form-check-label" style="font-size: 0.875rem;font-weight: 500;">View Transactions</span>
                                </label>
                            </div>
                        </div>
                    </div>

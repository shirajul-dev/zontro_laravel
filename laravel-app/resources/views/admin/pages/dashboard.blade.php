            ...
            <div class="col-auto ms-auto d-print-none">
                ...
                <h3 >
                    <?php
                        ...
                        $activeBrand = $global_response_brand['response'][0] ?? null;
                        $userTimezone = ($activeBrand['timezone'] ?? '') === '--' || empty($activeBrand['timezone'] ?? '') ? 'Asia/Dhaka' : $activeBrand['timezone'];
                    ...
                    <div class="card-body mb-0 pb-0">
                        ...
                        <div class="h1 mb-0">
                            <?php
                                ...
                                if ($activeBrandId) {
                                    $response_dashboard_info = json_decode( getData( $db_prefix.'transaction', ' WHERE brand_id = "'.$activeBrandId.'" AND status NOT IN ("initiated")'), true );
                    ...
                    <div class="card-body mb-0 pb-0">
                        ...
                        <div class="h1 mb-0">
                          <?php
                              ...
                              $activeBrandId = $global_response_brand['response'][0]['brand_id'] ?? null;
                              if ($activeBrandId) {
                                  $response_dashboard_info = json_decode(getData($db_prefix.'invoice',' WHERE brand_id = "'.$activeBrandId.'" AND status = "unpaid"'),true);
                                  if($response_dashboard_info['status'] == true){
                                      foreach($response_dashboard_info['response'] as $row){
                                          $count = $count+1;
                                      }
                    ...
                    <div class="card-body mb-0 pb-0">
                        ...
                        <div class="h1 mb-0">
                            <?php
                                ...
                                $activeBrandId = $global_response_brand['response'][0]['brand_id'] ?? null;
                                if ($activeBrandId) {
                                    $response_dashboard_info = json_decode(getData($db_prefix.'customer',' WHERE brand_id = "'.$activeBrandId.'"'),true);
                                    if($response_dashboard_info['status'] == true){
                                        foreach($response_dashboard_info['response'] as $row){
                                            $count = $count+1;
                                        }

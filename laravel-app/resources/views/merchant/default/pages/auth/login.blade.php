        ...
        <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
                ...
                <div>
                    ...
                    <form action="{{ route('merchant.login.post') }}" method="POST" x-data="{
                        loading: false,
                        showPassword: false,
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" id="username" name="username" value="{{ old('username') }}" required
                                    x-ref="username" placeholder="Enter your email or username"
                                    class="dark:bg-dark-900 h-11 w-full rounded-lg border {{ $errors->has('username') ? 'border-red-500' : 'border-gray-300' }} bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
                            <!-- Password -->
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                ...
                                <div class="relative">
                                    <input :type="showPassword ? 'text' : 'password'" name="password" required
                                        x-ref="password" placeholder="Enter your password"
                                        class="dark:bg-dark-900 h-11 w-full rounded-lg border {{ $errors->has('password') ? 'border-red-500' : 'border-gray-300' }} bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    <label for="checkboxLabelOne"
                                        ...
                                        <div class="relative">
                                            <input type="checkbox" id="checkboxLabelOne" class="sr-only" x-ref="remember"
                                    ...
                                    <template x-if="loading">
                                        <div class="flex items-center justify-center gap-2">
                                            <span class="animate-spin">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <circle opacity="0.5" cx="10" cy="10" r="8.75"
                                                        stroke="white" stroke-width="2.5"></circle>
                    ...
                    <div class="mt-5">
                        <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                            Not yet joined <strong>{{ config('app.name') }}</strong>?
                            <a href="#" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Join us
                                today!</a>
                        </p>
                    </div>
                </div>

...
<div class="p-4 md:p-6 lg:p-10">
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">Social Profiles</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 font-medium">Connect your business to social messaging platforms.</p>
        </div>
    </div>

    <div class="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 md:p-8 shadow-sm">
        @include('m::pages.settings.sections.social')
    </div>
</div>
@endsection

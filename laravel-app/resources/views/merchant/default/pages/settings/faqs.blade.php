...
@section('content')
    <div id="settings-container">
        ...
        <x-m::modal id="delete-faq-modal" type="brand" title="Delete FAQ"
            ...
            <x-slot name="icon">
                <div class="flex h-20 w-20 items-center justify-center rounded-full bg-red-50 text-red-500 dark:bg-red-500/10 mb-6 mx-auto">
                    <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <td class="px-5 py-4 text-right">
                                        <div x-data="{openDropDown: false}" class="relative inline-block text-left">
                                            ...
                                            <div x-show="openDropDown" @click.outside="openDropDown = false" x-transition
                                                class="absolute right-0 top-full z-40 mt-2 w-[200px] rounded-2xl border border-gray-200 bg-white p-1.5 shadow-theme-lg dark:border-gray-800 dark:bg-[#1E2635]"
                                                style="display: none;">
                                                <ul class="flex flex-col gap-0.5">
                                                    ...
                                                    <li>
                                                        <button @click="openDropDown = false; deleteFaqPrompt(${item.id})"
                                                            class="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors">

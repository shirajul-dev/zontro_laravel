            ...
            <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                <div
                    ...
                    <a href="index.html" class="lg:hidden">
                        <img class="dark:hidden" src="{{ m_asset('assets/images/logo/logo.svg') }}" alt="Logo" />
                        <img class="hidden dark:block" src="{{ m_asset('assets/images/logo/logo-dark.svg') }}"
                            alt="Logo" />
                    </a>
                                ...
                                <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                                    <li>
                                        <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                            ...
                                            <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img src="{{ m_asset('assets/images/user/user-02.jpg') }}"
                                    ...
                                    <li>
                                        <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                            href="#">
                                            <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img src="{{ m_asset('assets/images/user/user-03.jpg') }}"
                                                    alt="User" class="overflow-hidden rounded-full" />
                                                <span
                                                    class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                            </span>
                                    ...
                                    <li>
                                        <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                            href="#">
                                            <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img src="{{ m_asset('assets/images/user/user-04.jpg') }}"
                                                    alt="User" class="overflow-hidden rounded-full" />
                                                <span
                                                    class="bg-success-500 absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white dark:border-gray-900"></span>
                                            </span>
                                    ...
                                    <li>
                                        <a class="flex gap-3 rounded-lg border-b border-gray-100 p-3 px-4.5 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                            href="#">
                                            <span class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img src="{{ m_asset('assets/images/user/user-05.jpg') }}"
                                                    alt="User" class="overflow-hidden rounded-full" />
                                                <span
                    ...
                    <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                        <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                            ...
                            <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                                <img src="{{ m_asset('assets/images/user/owner.jpg') }}" alt="User" />
                            </span>
                        ...
                        <div x-show="dropdownOpen"
                            ...
                            <ul class="flex flex-col gap-1 pt-4 pb-0">
                                <li>
                                    <a href="profile.html"
                                ...
                                <li class="border-b border-gray-200 pb-3 dark:border-gray-800">
                                ...
                                <li class="relative" x-data="{ submenuOpen: false }" @click.outside="submenuOpen = false">
                                    <a href="javascript:void(0)"
                                        @click.prevent="submenuOpen = !submenuOpen"
                                        class="group text-theme-sm flex items-center justify-between rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                        ...
                                        <svg :class="submenuOpen && 'rotate-90'" class="duration-200 stroke-gray-500 group-hover:stroke-gray-700 dark:stroke-gray-400 dark:group-hover:stroke-gray-300" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div x-show="submenuOpen" 
                                        ...
                                        class="shadow-theme-lg dark:bg-gray-dark absolute right-[102%] top-[-12px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800">
                                        <div class="px-3 pt-1 pb-1">
                                            <span class="text-xs font-medium uppercase tracking-wider text-gray-400">Switch Account</span>
                                        </div>
                                        <ul class="flex flex-col gap-1">
                                            @foreach ($merchantBrands ?? [] as $brand)
                                                @php
                                                    $isActive = $activeBrand && $brand->id === $activeBrand->id;
                                                @endphp
                                                <li>
                                                    <a href="{{ $isActive ? 'javascript:void(0)' : route('merchant.switch-brand', $brand->id) }}"
                                                        @click="if(!{{ $isActive ? 'true' : 'false' }}) window.location.href = '{{ route('merchant.switch-brand', $brand->id) }}'"
                                                        class="group flex items-center justify-between rounded-lg px-3 py-2 hover:bg-gray-100 dark:hover:bg-white/5 {{ $isActive ? 'bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-gray-700' : '' }}">
                                                        <div class="flex items-center gap-3">
                                                            <div class="h-8 w-8 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800 flex items-center justify-center bg-gray-50 dark:bg-gray-800">
                                                                @if ($brand->favicon)
                                                                    <img src="{{ asset($brand->favicon) }}" alt="" class="h-full w-full object-contain" />
                                                                @else
                                                            ...
                                                            <div class="flex flex-col">
                                                                ...
                                                                <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">{{ $brand->brand_id }}</span>
                                                            </div>
                                                        </div>
                                                        @if ($isActive)
                            ...
                            <button
                                class="border-t border-gray-200 dark:border-gray-800 group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">

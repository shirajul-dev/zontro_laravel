      ...
      <aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
          ...
          <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
              ...
              <div class="logo w-full relative" :class="sidebarToggle ? 'hidden' : 'block'" x-data="{ brandDropdownOpen: false }">
                  <div @click="brandDropdownOpen = !brandDropdownOpen" class="flex items-center justify-between w-full cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 p-2.5 -mx-2.5 rounded-xl transition-colors">
                      <!-- Switcher Text (Left) -->
                      <div class="flex flex-col justify-center group">
                          ...
                          <div class="flex items-center gap-1.5 mt-2">
                              ...
                              <span class="text-[13px] text-gray-500 dark:text-gray-400 leading-none">Active brand</span>
                          </div>
                      </div>

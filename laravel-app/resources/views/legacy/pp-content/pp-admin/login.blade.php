    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <img src="{{ $logoLightUrl }}" alt="" style=" height: 40px; ">
            </div>
                ...
                <div class="card-body">
                    ...
                    <form action="" class="form-method">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="username" placeholder="Enter email or username" value="{{ $demoMode ? 'demo@piprapay.com' : '' }}" required>
                        </div>
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" class="form-control password-input" name="password" placeholder="Enter password" value="{{ $demoMode ? '12345678' : '' }}" required>

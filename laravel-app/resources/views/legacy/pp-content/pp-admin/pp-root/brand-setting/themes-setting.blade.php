<?php
    ...
    if ($slug === null) {
        ...
        if($global_response_brand['response'][0]['theme'] !== $slug){
            ...
            $moduleBase = realpath(base_path('pp-content/pp-modules/pp-themes'));
            $classFile = null;

            if ($moduleBase !== false && preg_match('/^[a-z0-9][a-z0-9-]*$/', $slug)) {
                $candidate = $moduleBase . DIRECTORY_SEPARATOR . $slug . DIRECTORY_SEPARATOR . 'class.php';

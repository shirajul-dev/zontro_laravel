...
function pp_gateway_info($gateway_id = '', $data = [])
{
    ...
    if ($gateway) {
        ...
        if ($isAboveMin && $isBelowMax) {
            if (file_exists(app_path('Modules/gateways/' . $row->slug . '/class.php'))) {
                require_once app_path('Modules/gateways/' . $row->slug . '/class.php');
...
function pp_gateway_render($gateway_id = '', $data = [])
{
    ...
    if ($gatewayRow) {
        ...
        } elseif (file_exists(app_path('Modules/gateways/' . $gatewayRow->slug . '/class.php'))) {
            require_once app_path('Modules/gateways/' . $gatewayRow->slug . '/class.php');

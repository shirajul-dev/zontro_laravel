...
import $feVgu$react, {createContext as $feVgu$createContext, forwardRef as $feVgu$forwardRef, useMemo as $feVgu$useMemo, useRef as $feVgu$useRef, useState as $feVgu$useState, useCallback as $feVgu$useCallback, useContext as $feVgu$useContext} from "react";
...
const $ddc2347ad81bd857$export$72b9695b8216309a = /*#__PURE__*/ (0, $feVgu$forwardRef)(function ComboBox(props, ref) {

...
const $365d89633c2041bc$export$48513f6b9f8ce62d = /*#__PURE__*/ (0, $c6KLw$react.forwardRef)(function Checkbox(props, ref) {
    ...
    let { labelProps: labelProps, inputProps: inputProps, isSelected: isSelected, isDisabled: isDisabled, isReadOnly: isReadOnly, isPressed: isPressed, isInvalid: isInvalid } = groupState ? (0, $c6KLw$reactariauseCheckboxGroup.useCheckboxGroupItem)({
    ...
    }, groupState, inputRef) : (0, $c6KLw$reactariauseCheckbox.useCheckbox)({
        ...(0, $048d76b84370f141$exports.removeDataAttributes)(props),
        children: typeof props.children === 'function' ? true : props.children,
        validationBehavior: validationBehavior
    }, (0, $c6KLw$reactstatelyuseToggleState.useToggleState)(props), inputRef);

...
import $eiyUW$react, {createContext as $eiyUW$createContext, forwardRef as $eiyUW$forwardRef, useRef as $eiyUW$useRef, useState as $eiyUW$useState, useCallback as $eiyUW$useCallback} from "react";
import {useFocusRing as $eiyUW$useFocusRing} from "react-aria/useFocusRing";
import {useResizeObserver as $eiyUW$useResizeObserver} from "react-aria/private/utils/useResizeObserver";
...
const $97391356e321081b$export$5109c6dd95d8fb00 = /*#__PURE__*/ (0, $eiyUW$forwardRef)(function DatePicker(props, ref) {
    ...
    let [groupWidth, setGroupWidth] = (0, $eiyUW$useState)(null);
    let onResize = (0, $eiyUW$useCallback)(()=>{
        if (groupRef.current) setGroupWidth(groupRef.current.offsetWidth + 'px');
    }, []);
    (0, $eiyUW$useResizeObserver)({
        ref: groupRef,
        onResize: onResize
    });

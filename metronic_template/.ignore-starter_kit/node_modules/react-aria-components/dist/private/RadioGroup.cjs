...
const $ecfe484c0a342e33$export$d7b12c4107be0d61 = /*#__PURE__*/ (0, $kyCvN$react.forwardRef)(function Radio(props, ref) {
    ...
    let { labelProps: labelProps, inputProps: inputProps, isSelected: isSelected, isDisabled: isDisabled, isPressed: isPressed } = (0, $kyCvN$reactariauseRadioGroup.useRadio)({
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($kyCvN$react))).createElement((0, $048d76b84370f141$exports.dom).label, {
        ...
        ref: inputRef
    })), /*#__PURE__*/ (0, ($parcel$interopDefault($kyCvN$react))).createElement((0, $61557b2a9b2862a8$exports.SelectionIndicatorContext).Provider, {
        value: {
            isSelected: isSelected
        }

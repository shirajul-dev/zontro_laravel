...
var $fDx7A$reactariaprivateutilsuseResizeObserver = require("react-aria/private/utils/useResizeObserver");
...
function $76f9e98b4261ab43$export$27d2ad3c5815583e(props) {
    ...
    let [buttonWidth, setButtonWidth] = (0, $fDx7A$react.useState)(null);
    let onResize = (0, $fDx7A$react.useCallback)(()=>{
        if (ref.current) setButtonWidth(ref.current.offsetWidth + 'px');
    }, [
        ref
    ]);
    (0, $fDx7A$reactariaprivateutilsuseResizeObserver.useResizeObserver)({
        ref: ref,
        onResize: onResize
    });

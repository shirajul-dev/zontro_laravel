...
var $4d5fb986d6106af2$exports = require("./TableLayout.cjs");
...
class $af9b3e5459f1bf61$var$TableCollection extends (0, $ke19Y$reactariaprivatecollectionsBaseCollection.BaseCollection) {
    ...
    *[Symbol.iterator]() {
    ...
    constructor(...args){
        super(...args), this.headerRows = [], this.columns = [], this.rows = [], this.rowHeaderColumnKeys = new Set(), this.head = new $af9b3e5459f1bf61$var$TableHeaderNode(-1), this.body = new $af9b3e5459f1bf61$var$TableBodyNode(-2), this.columnsDirty = true, this.expandedKeys = new Set();
    }
}
...
const $af9b3e5459f1bf61$export$76ccd210b9029917 = /*#__PURE__*/ (0, $ke19Y$reactariaCollectionBuilder.createBranchComponent)($af9b3e5459f1bf61$var$TableBodyNode, (props, ref)=>{
    let state = (0, $ke19Y$react.useContext)($af9b3e5459f1bf61$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, $ke19Y$react.useContext)((0, $f7b82bedbb70abac$exports.CollectionRendererContext));

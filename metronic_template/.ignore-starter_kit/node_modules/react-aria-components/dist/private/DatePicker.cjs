...
var $7wQ3T$reactariaprivateutilsuseResizeObserver = require("react-aria/private/utils/useResizeObserver");
...
const $e06e9b1044c23255$export$5109c6dd95d8fb00 = /*#__PURE__*/ (0, $7wQ3T$react.forwardRef)(function DatePicker(props, ref) {
    ...
    let [groupWidth, setGroupWidth] = (0, $7wQ3T$react.useState)(null);
    let onResize = (0, $7wQ3T$react.useCallback)(()=>{
        if (groupRef.current) setGroupWidth(groupRef.current.offsetWidth + 'px');
    }, []);
    (0, $7wQ3T$reactariaprivateutilsuseResizeObserver.useResizeObserver)({
        ref: groupRef,
        onResize: onResize
    });

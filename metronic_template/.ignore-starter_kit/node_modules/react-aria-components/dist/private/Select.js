...
import $2OPXg$react, {createContext as $2OPXg$createContext, forwardRef as $2OPXg$forwardRef, useMemo as $2OPXg$useMemo, useRef as $2OPXg$useRef, useState as $2OPXg$useState, useCallback as $2OPXg$useCallback, useContext as $2OPXg$useContext, Fragment as $2OPXg$Fragment} from "react";
...
import {useResizeObserver as $2OPXg$useResizeObserver} from "react-aria/private/utils/useResizeObserver";
...
const $5ade0166931ef32f$export$ef9b1a59e592288f = /*#__PURE__*/ (0, $2OPXg$forwardRef)(function Select(props, ref) {
...
function $5ade0166931ef32f$var$SelectInner({ props: props, selectRef: ref, collection: collection }) {
    ...
    let [buttonWidth, setButtonWidth] = (0, $2OPXg$useState)(null);
    let onResize = (0, $2OPXg$useCallback)(()=>{
        if (buttonRef.current) setButtonWidth(buttonRef.current.offsetWidth + 'px');
    }, [
        buttonRef
    ]);
    (0, $2OPXg$useResizeObserver)({
        ref: buttonRef,
        onResize: onResize
    });

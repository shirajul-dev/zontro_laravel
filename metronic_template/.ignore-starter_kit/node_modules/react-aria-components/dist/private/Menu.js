...
import $gKmcL$react, {createContext as $gKmcL$createContext, useRef as $gKmcL$useRef, useState as $gKmcL$useState, useCallback as $gKmcL$useCallback, useContext as $gKmcL$useContext, forwardRef as $gKmcL$forwardRef, useMemo as $gKmcL$useMemo} from "react";
...
import {useResizeObserver as $gKmcL$useResizeObserver} from "react-aria/private/utils/useResizeObserver";
...
function $113aa0613e727c6c$export$27d2ad3c5815583e(props) {
    ...
    let [buttonWidth, setButtonWidth] = (0, $gKmcL$useState)(null);
    let onResize = (0, $gKmcL$useCallback)(()=>{
        if (ref.current) setButtonWidth(ref.current.offsetWidth + 'px');
    }, [
        ref
    ]);
    (0, $gKmcL$useResizeObserver)({
        ref: ref,
        onResize: onResize
    });

...
var $75P61$reactariaprivateutilsuseResizeObserver = require("react-aria/private/utils/useResizeObserver");
...
const $4080fc4198ecec34$export$ef9b1a59e592288f = /*#__PURE__*/ (0, $75P61$react.forwardRef)(function Select(props, ref) {
...
function $4080fc4198ecec34$var$SelectInner({ props: props, selectRef: ref, collection: collection }) {
    ...
    let [buttonWidth, setButtonWidth] = (0, $75P61$react.useState)(null);
    let onResize = (0, $75P61$react.useCallback)(()=>{
        if (buttonRef.current) setButtonWidth(buttonRef.current.offsetWidth + 'px');
    }, [
        buttonRef
    ]);
    (0, $75P61$reactariaprivateutilsuseResizeObserver.useResizeObserver)({
        ref: buttonRef,
        onResize: onResize
    });
